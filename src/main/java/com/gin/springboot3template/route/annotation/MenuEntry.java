...
/**
 * 导航项入口, 在 {@link com.gin.springboot3template.route.annotation.MenuItem} 的方法上标记，表示该方法需要参与对 disabled 字段的计算; 不使用本注解时, 该字段永远为 false
 * @author : ginstone
 * @version : v1.0.0
...
public @interface MenuEntry {
    /**
     * 展示策略，决定 disabled字段值的策略, 优先级高于 {@link com.gin.springboot3template.route.annotation.MenuItem} 的同名字段
     */
